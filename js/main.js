...
const cellSize = Math.floor(Math.sqrt(clientHeight * clientWidth / maxCellsCount));
...
const cellsHTML = `<div class="cell" style="width: ${cellSize}px; height: ${cellSize}px;"></div>`.repeat(width * height);
...
function gameLoop() {
    ...
    if (snakeLocation.at(-1).x + direction.x === appleLocation.x
